...
export default function CreateTenant() {
  ...
  const textareaClass =
    'w-full rounded-md border border-[rgb(var(--border))] bg-surface text-app px-3 py-2 outline-none transition-all duration-150 focus:border-[rgb(var(--primary-hover))]';
      ...
      <div className="mx-auto max-w-4xl pb-12">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <section className={sectionClass}>
            <h2 className="mb-5 text-lg font-semibold text-[rgb(var(--primary))]">
